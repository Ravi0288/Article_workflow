# Generated by Django 4.2 on 2024-03-18 13:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', actions.common.EncryptedField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_token', actions.common.EncryptedField(blank=True, null=True)),
                ('minimum_delivery_fq', models.IntegerField()),
                ('last_pull_status', models.CharField(default='success', max_length=10)),
                ('last_error_message', models.TextField(blank=True, null=True)),
                ('next_due_date', models.DateTimeField(null=True)),
                ...
                ('email_notification', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='actions.email_notification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(default='success', max_length=10)),
                ('email_ref', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='email_notification', to='actions.email_notification')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file_content', models.FileField(blank=True, null=True, storage=actions.archive_article.OverWriteStorage(), upload_to=actions.archive_article.get_file_path)),
                ...
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='archives', to='actions.provider_model')),
            ],
        ),
    ]
